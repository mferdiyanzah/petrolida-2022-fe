...
import { stRegistration } from '../../services/comp_registration'
...
const STCRegistration = () => {
  const [token] = useCookie('token')
  useTitle('Register to Stock Trading Competition | Petrolida 2022')
    ...
    <div className='body'>
      ...
      <header id="regis-header" style={{marginTop: '100px'}}>
        <div className="container">
          <h1 className="header-title my-2">Register for Stock Trading Competition</h1>
...
export default STCRegistration