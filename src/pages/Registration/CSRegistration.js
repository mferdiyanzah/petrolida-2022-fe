...
import { csRegistration } from '../../services/comp_registration'
...
const CSRegistration = () => {
  const [token] = useCookie('token')
  useTitle('Register to Case Study Competition | Petrolida 2022')
    ...
    <div className='body'>
      ...
      <header id="regis-header" style={{marginTop: '100px'}}>
        <div className="container">
          <h1 className="header-title my-2">Register for Case Study Competition</h1>
