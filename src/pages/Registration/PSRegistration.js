...
import { psRegistration } from '../../services/comp_registration'
...
const PSRegistration = () => {
  const [token] = useCookie('token')
  useTitle('Register to Petrosmart Competition | Petrolida 2022')
    ...
    <div className='body'>
      ...
      <header id="regis-header" style={{marginTop: '100px'}}>
        <div className="container">
          <h1 className="header-title my-2">Register for Petrosmart Competition</h1>
