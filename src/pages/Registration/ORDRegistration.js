...
import { ordRegistration, psRegistration } from '../../services/comp_registration'
...
const ORDRegistration = () => {
  ...
  useTitle('Register to Oil Rig Design Competition | Petrolida 2022')
  ...
  const handleSubmit = e => {
    ...
    ordRegistration(token, dataForm)
      .then(res => {
    ...
    <div className='body'>
      ...
      <header id="regis-header" style={{marginTop: '100px'}}>
        <div className="container">
          <h1 className="header-title my-2">Register for Oil Rig Design Competition</h1>
              ...
              <form onSubmit={e => handleSubmit(e)} noValidate>
                ...
                <div id="informationForm" className="form-container">
                  ...
                  <div id="secondForm" style={{display: 'none'}}>
                    ...
                    <h3 className="form-section h7">Team Member 3*</h3>
                    <div className="my-3">
                      <label htmlFor="member2_name" className="form-label">Full Name</label>
                      <input required type="text" className="form-input" id="member3_name" onChange={e => setData({...data, member3_name: e.target.value})} name="member2_name" tabIndex="10" placeholder="Enter your full name"/>
                    </div>
                    <div className="my-3">
                      <label htmlFor="member2_email" className="form-label">Email</label>
                      <input required type="email" className="form-input" id="member3_email" onChange={e => setData({...data, member3_email: e.target.value})} name="member2_email" tabIndex="11" placeholder="Enter your email"/>
                    </div>
                    <div className="my-3">
                      <label htmlFor="membe3_phone" className="form-label">Phone Number</label>
                      <input required type="text" className="form-input" onChange={e => setData({...data, member3_phone: e.target.value})} id="member2_phone" name="member2_phone" tabIndex="12" placeholder="Enter your phone number"/>
                    </div>
                    <h3 className="form-section h7">Team Member 4</h3>
                    <div className="my-3">
                      <label htmlFor="member2_name" className="form-label">Full Name</label>
                      <input required type="text" className="form-input" id="member3_name" onChange={e => setData({...data, member4_name: e.target.value})} name="member2_name" tabIndex="10" placeholder="Enter your full name"/>
                    </div>
                    <div className="my-3">
                      <label htmlFor="member2_email" className="form-label">Email</label>
                      <input required type="email" className="form-input" id="member3_email" onChange={e => setData({...data, member4_email: e.target.value})} name="member2_email" tabIndex="11" placeholder="Enter your email"/>
                    </div>
                    <div className="my-3">
                      <label htmlFor="membe3_phone" className="form-label">Phone Number</label>
                      <input required type="text" className="form-input" onChange={e => setData({...data, member4_phone: e.target.value})} id="member2_phone" name="member2_phone" tabIndex="12" placeholder="Enter your phone number"/>
                    </div>
...
export default ORDRegistration